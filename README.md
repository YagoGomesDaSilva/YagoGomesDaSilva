...
Desenvolvedor Back-End com 3 anos de experiência em .NET (C#, VB), ASP.NET Core e Java Spring Boot.
Experiência em automação, integração de sistemas, migração de aplicações legadas.
Experiência com Docker, Linux, versionamento e testes automatizados.
